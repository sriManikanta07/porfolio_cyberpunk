...
const stackCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'RAG Systems', abbr: 'RAG', desc: 'Retrieval Augmented', level: 80 },
      { name: 'Vector DBs', abbr: 'VDB', desc: 'Embeddings Store', level: 75 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Docker', abbr: 'DKR', desc: 'Containerization', level: 72 },
      { name: 'GraphQL', abbr: 'GQL', desc: 'Query Language', level: 70 },
...
export default function TechStack() {
  ...
  return (
    <section id="stack" ref={ref} className="relative py-28 overflow-hidden" style={{ background: 'var(--surface)' }}>
      {/* Grid bg */}
      <div
      ...
      <div
        ...
        style={{
          top: '40%',
          height: '1px',
          background: 'linear-gradient(90deg, transparent, rgba(0,245,255,0.1), rgba(255,0,110,0.1), transparent)',
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(105deg, transparent 45%, rgba(0,245,255,0.03) 45%, rgba(0,245,255,0.03) 55%, transparent 55%)',
              }}
            />
            ...
            {featuredIcons.map((icon, i) => (
              <div
                ...
                style={{
                  ...
                  opacity: inView ? 1 : 0,
                  transform: inView ? 'none' : `translateY(${i % 2 === 0 ? '-' : ''}20px)`,
              ...
              >
                ...
                <span className="mono text-center" style={{ color: 'var(--text-muted)', fontSize: '9px', letterSpacing: '1px' }}>
                  {icon.name}
                </span>
              </div>
            ))}
                ...
                {cat.items.map((item, ii) => (
                  <div key={ii}>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="mono text-xs" style={{ color: 'var(--text-muted)', fontSize: '10px' }}>
                        {item.level}%
                      </span>
                    </div>
                    <p className="mono mb-1.5" style={{ color: 'var(--text-muted)', fontSize: '10px' }}>
                      {item.desc}
                    </p>
                    {/* Progress bar */}
                    <div
