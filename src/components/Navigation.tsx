    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="orbitron font-bold text-sm leading-none" style={{ color: 'var(--cyan)', letterSpacing: '2px' }}>
              SRI<span style={{ color: 'var(--magenta)' }}>.</span>DEV
            </div>
            <div className="mono text-xs" style={{ color: 'var(--text-muted)', letterSpacing: '1px', fontSize: '9px' }}>
              v2.0.26 // ONLINE
            </div>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center gap-1">
          {navLinks.map((link) => (
            ...
            >
              ...
              />
              <span className="relative group-hover:text-white transition-colors">{link.label}</span>
            </a>
          ))}
        </div>
